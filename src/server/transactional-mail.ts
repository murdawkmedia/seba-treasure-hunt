...
export function isValidTransactionalHeaderValue(value: string): boolean {
  try {
    validatedHeader("transactional", value);
    return true;
  } catch {
    return false;
  }
...
export function isValidTransactionalEmailAddress(value: string): boolean {
  try {
    validatedEmailHeader("transactional", value);
    return true;
  } catch {
    return false;
  }
