...
function renderGallery() {
  ...
  if (!grid) return;
  var tiles = [
    { icon: "📷", label: "Hunters at Skull Rock HQ", video: false },
    { icon: "🎥", label: "Drone flyover of the lake", video: true },
    { icon: "📷", label: "Cracking the Cozy Cove clue", video: false },
    { icon: "🎥", label: "Vows at Lovers' Lagoon", video: true },
    { icon: "📷", label: "Marshmallows at the Wharf", video: false },
